...
class User(TimestampMixin):
    role: fields.ManyToManyRelation["Role"] = fields.ManyToManyField("demo.Role", related_name="user", on_delete=fields.CASCADE)
...
class Role(TimestampMixin):
    ...
    access: fields.ManyToManyRelation["Access"] = \
        fields.ManyToManyField("demo.Access", related_name="role", on_delete=fields.CASCADE)
